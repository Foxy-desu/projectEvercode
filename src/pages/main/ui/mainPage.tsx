...
const MainPage = ({ isMinimized, resetThresholdReached, stopReconcilation, viewportWidth, data }: IMainPage) => {
  ...
  return (
    <>
      ...
      <div className={cl.contentWrap} ref={scrollTarget}>
        <Section sectionTitle="<span>Разрабатываем микросервисы,</span> мобильные и&nbsp;веб-приложения для бизнеса и&nbsp;стартапов">
          <AppsList
            appList={appList}
    ...
    <>
      ...
      {isMinimized ? (
        <div className={cl.btnWrap}>
          <RoundBtn
            purpose="expandControl"
            prompt="Раскрыть список"
            onClick={() => {
