    ...
    <footer className={cl.footer}>
      <div className={cl.content}>
        ...
        <div className={cl.accordionWrap}>
          <Acordion
            isOpen={accordeonOpen}
            titleOpen="Свернуть меню"
            titleClosed="Развернуть меню"
...
const Acordion = ({ children, titleOpen, titleClosed, isOpen, clickHandler }: IAcordeon) => {
  ...
  return (
    <div className={cl.accordion}>
      ...
      <div className={accordionContentStyle}>{children}</div>
    </div>
  );
};
